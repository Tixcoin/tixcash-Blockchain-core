...
import (
	...
	"github.com/Tixcash-foundation/go-opera/integration"
	...
	futils "github.com/Tixcash-foundation/go-opera/utils"
...
var (
	...
	RPCGlobalGasCapFlag = cli.Uint64Flag{
		Name:  "rpc.gascap",
		Usage: "Sets a cap on gas that can be used in txh_call/estimateGas (0=infinite)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCGasCap,
	}
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in TXH) that can be sent via the RPC APIs (0 = no cap)",
...
func mayGetGenesisStore(ctx *cli.Context) *genesisstore.Store {
	...
	case ctx.GlobalIsSet(FakeNetFlag.Name):
		...
		return makefakegenesis.FakeGenesisStore(num, futils.ToTxh(1000000000), futils.ToTxh(5000000))
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "eth", "tixcash", "dag", "abft", "web3")
	cfg.WSModules = append(cfg.WSModules, "eth", "tixcash", "dag", "abft", "web3")
