...
import (
	...
	"github.com/Tixcash-foundation/go-opera/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/Tixcash-foundation/go-opera/gossip/emitter External,TxPool,TxSigner,Signer
