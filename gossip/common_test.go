...
import (
	...
	"github.com/Tixcash-foundation/go-opera/utils/adapters/vecmt2dagidx"
...
func newTestEnv(firstEpoch idx.Epoch, validatorsNum idx.Validator) *testEnv {
	...
	genStore := makefakegenesis.FakeGenesisStoreWithRulesAndStart(validatorsNum, utils.ToTxh(genesisBalance), utils.ToTxh(genesisStake), rules, firstEpoch, 2)
