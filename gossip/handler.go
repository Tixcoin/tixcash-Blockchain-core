...
import (
	...
	"github.com/Tixcash-foundation/lachesis-base/gossip/dagprocessor"
	"github.com/Tixcash-foundation/lachesis-base/gossip/itemsfetcher"
	"github.com/Tixcash-foundation/lachesis-base/hash"
	"github.com/Tixcash-foundation/lachesis-base/inter/dag"
	"github.com/Tixcash-foundation/lachesis-base/inter/idx"
	"github.com/Tixcash-foundation/lachesis-base/utils/datasemaphore"
	...
	"github.com/Tixcash-foundation/go-opera/eventcheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/bvallcheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/epochcheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/evallcheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/heavycheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/parentlesscheck"
	"github.com/Tixcash-foundation/go-opera/evmcore"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockrecords/brprocessor"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockrecords/brstream"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockrecords/brstream/brstreamleecher"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockrecords/brstream/brstreamseeder"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockvotes/bvprocessor"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockvotes/bvstream"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockvotes/bvstream/bvstreamleecher"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/blockvotes/bvstream/bvstreamseeder"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/dag/dagstream"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/dag/dagstream/dagstreamleecher"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/dag/dagstream/dagstreamseeder"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/epochpacks/epprocessor"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/epochpacks/epstream"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/epochpacks/epstream/epstreamleecher"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/epochpacks/epstream/epstreamseeder"
	"github.com/Tixcash-foundation/go-opera/gossip/protocols/snap/snapstream/snapleecher"
	"github.com/Tixcash-foundation/go-opera/inter"
	"github.com/Tixcash-foundation/go-opera/inter/ibr"
	"github.com/Tixcash-foundation/go-opera/inter/ier"
	"github.com/Tixcash-foundation/go-opera/logger"
)
...
// newHandler returns a new Tixcash sub protocol manager. The Tixcash sub protocol manages peers capable
// with the Tixcash network.
func newHandler(
	c handlerConfig,
) (
	*handler,
...
func (h *handler) Stop() {
	log.Info("Stopping Tixcash protocol")
	...
	log.Info("Tixcash protocol stopped")
}
...
func (h *handler) handle(p *peer) error {
	...
	if p.RunningCap(ProtocolName, []uint{TXH63}) {
