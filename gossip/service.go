...
import (
	...
	"github.com/Tixcash-foundation/lachesis-base/lachesis"
	"github.com/Tixcash-foundation/lachesis-base/utils/workers"
	...
	"github.com/Tixcash-foundation/go-opera/ethapi"
	"github.com/Tixcash-foundation/go-opera/eventcheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/basiccheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/epochcheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/gaspowercheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/heavycheck"
	"github.com/Tixcash-foundation/go-opera/eventcheck/parentscheck"
	"github.com/Tixcash-foundation/go-opera/evmcore"
	"github.com/Tixcash-foundation/go-opera/gossip/blockproc"
	"github.com/Tixcash-foundation/go-opera/gossip/blockproc/drivermodule"
	"github.com/Tixcash-foundation/go-opera/gossip/blockproc/eventmodule"
	"github.com/Tixcash-foundation/go-opera/gossip/blockproc/evmmodule"
	"github.com/Tixcash-foundation/go-opera/gossip/blockproc/sealmodule"
	"github.com/Tixcash-foundation/go-opera/gossip/blockproc/verwatcher"
	"github.com/Tixcash-foundation/go-opera/gossip/emitter"
	"github.com/Tixcash-foundation/go-opera/gossip/filters"
	"github.com/Tixcash-foundation/go-opera/gossip/gasprice"
	"github.com/Tixcash-foundation/go-opera/gossip/proclogger"
	snapsync "github.com/Tixcash-foundation/go-opera/gossip/protocols/snap"
	"github.com/Tixcash-foundation/go-opera/inter"
	"github.com/Tixcash-foundation/go-opera/logger"
	"github.com/Tixcash-foundation/go-opera/utils/signers/gsignercache"
	"github.com/Tixcash-foundation/go-opera/utils/wgmutex"
	"github.com/Tixcash-foundation/go-opera/valkeystore"
...
func (s *Service) Stop() error {
	defer log.Info("Tixcash service stopped")
	s.verWatcher.Stop()
	for _, em := range s.emitters {
		em.Stop()
	}
