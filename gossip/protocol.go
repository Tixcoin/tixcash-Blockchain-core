...
import (
	...
	"github.com/Tixcash-foundation/go-opera/inter/iep"
)
...
var ProtocolVersions = []uint{TXH62, TXH63}

// protocolLengths are the number of implemented message corresponding to different protocol versions.
var protocolLengths = map[uint]uint64{TXH62: EventsStreamResponse + 1, TXH63: EPsStreamResponse + 1}
